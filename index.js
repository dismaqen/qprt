...
(async () => {
  while (true) {
    const browser = await puppeteer.launch({
      headless: true, // 👉 Bikin browser jalan di background (tidak kelihatan)
    ...
    // Delay acak sebelum loop berikutnya
